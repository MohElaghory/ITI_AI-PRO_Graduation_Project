...
def verify_mail(email, otp):
    ...
    msg = Message('Flask APP verification', sender = 'XXXXX', recipients = [user_email])  
...
def send_recommendations_to_mail(user_info, movie_genres, recommendations):
    ...
    msg = Message('Movie Recommendations from Flask APP', sender ='XXXXX', recipients = [user_email] )
